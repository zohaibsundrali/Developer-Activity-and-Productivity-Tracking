...
2. Preserve the historical migrations through 096 and the two audit migrations already supplied. Apply the six new timestamped migrations in ascending order: `20260911055537`, `20260911060849`, `20260911062113`, `20260911062805`, `20260911063616`, `20260911065148`. **Never run `database/tests/*` in Supabase.** They create synthetic schemas and roles.
