-- ============================================================================
--  091 - role_permissions: the asset and licence keys
--
--  WHAT CHANGED
--
--  Migration 090 added assets, software licences and the chain of custody.
--  Four keys:
--
...
--  reason there are two rather than one. Handing somebody a laptop is part of
--  onboarding and offboarding, which is HR's process. Buying seats is recurring
--  spend against a renewal date, which is finance's.
--
--  NEITHER IS A manager. An asset register a project manager can edit stops
--  being a register of what the company owns.
--
--  SEEING WHAT YOU YOURSELF HOLD IS NOT A KEY. It is a fact about the row,
--  granted by the RLS policies in 090 the same way the hiring manager reads
--  their own opening's candidates in 085. Nobody should need a permission to
--  ask what they are signed out.
--
...
-- PART 1 -- every row the catalogue defines. 443 rows over 99 keys.
...
-- ---------------------------------------------------------------------
--  Expect 443 rows over 99 distinct keys.
