...
--  This one WRITES DATA. Run the verify query underneath it afterwards.
-- =====================================================================
...
--  47 composite indexes. RUN STEP 0 FIRST. These builds hold a write-blocking
...
select status, count(*) as unreviewed_terminal from public.developer_tasks where reviewed_at is null and status in ('completed','rejected') group by status;
