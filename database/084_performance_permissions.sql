-- ============================================================================
--  084 - role_permissions: the performance keys
--
--  WHAT CHANGED
--
--  Migration 083 added review cycles, performance reviews and goals. Five keys:
--
--    review_cycle.manage / review.view_all   owner, admin, hr
--    review.write / goal.manage              owner, admin, hr, manager, team_lead
--    review.view_own                         every staff role
--
--  WRITING A REVIEW IS WIDER THAN RUNNING THE CYCLE. A manager and a team lead
--  assess the people they work with; opening and closing the period is people
--  operations. There is no review.view_all for either of them -- a reviewer
--  reads the reviews THEY wrote, which the RLS policy grants on authorship
--  rather than on a key, and reading everybody's assessment of everybody is a
--  different thing that belongs with HR.
--
--  review.view_own is STAFF because everybody is reviewed, an owner included.
--  It only ever returns a SHARED review: a half-written assessment is a draft
--  its author would edit if they knew it was being read.
--
...
-- PART 1 -- every row the catalogue defines. 409 rows over 89 keys.
...
-- ---------------------------------------------------------------------
--  Expect 409 rows over 89 distinct keys.
