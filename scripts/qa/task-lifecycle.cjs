...
const save=()=>fs.writeFileSync(`${process.env.QA_ARTIFACT_DIR || 'artifacts/deep-qa-20260921'}/task-lifecycle.json`,JSON.stringify({name,results,created,files},null,2),{mode:0o600});
